...
#  dict_keys(['single_select', 'multi_select', 'build_queue', 'cargo', 'production_queue', 'last_actions', \
...
# 'score_by_vital', 'player', 'control_groups', 'upgrades', 'available_actions']) 
  ...
  try:
    with sc2_env.SC2Env(
        ...
        players=[sc2_env.Agent(sc2_env.Race.terran), 
                  ...
                  # # 1. Enable the following if using agent.
                  sc2_env.Agent(sc2_env.Race.terran)],

                  # 2. Enable the following if using bot
